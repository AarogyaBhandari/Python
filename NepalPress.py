...
# Target URL
url = 'https://english.nepalpress.com/'

response = requests.get(url)
soup = BeautifulSoup(response.text, features='html.parser')

trending_topics = soup.find_all('div', class_='mt35')
...
for article_url in trending_article:
    ...
    content_paragraphs = article_soup.find('div', class_='news-content-area uk-text-justify').find_all('p')
    content = '\n'.join(
...
with open('NepalPress.json', 'a', encoding='utf-8') as f:
